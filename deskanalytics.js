...
var tracking_script = 'ga.js'/*tpa=http://deskwww.s3.amazonaws.com/new/javascripts/ga.js*/;
...
var cnd = (function(hostname){
  ...
  // Select a configuration based on hostname (last two, e.g. "http://deskwww.s3.amazonaws.com/new/javascripts/assistly.com")
  switch(hx){
    case 'staging':
      return {
    ...
    case 'http://deskwww.s3.amazonaws.com/new/javascripts/assistly.com':
    case 'http://deskwww.s3.amazonaws.com/new/javascripts/desk.com':
    default:
      return {
        name: 'assistly.', // tracker prefix
        namespace: 'astly', // cookie namespace (deprecated)
...
if(_assistly_portal(document.location)) {
  ...
  // Specifically for multiple GlossyBox sites so that our GA code doesn't affect their portal - it's okay that we may
    ...
    // old urchin tracking
    var _uhq = _uhq || [];
    tracking_script = 'uh.js'/*tpa=http://deskwww.s3.amazonaws.com/new/javascripts/uh.js*/;
...
switch(tracking_script){
  case 'ga.js'/*tpa=http://deskwww.s3.amazonaws.com/new/javascripts/ga.js*/:
    (function() {
  ...
  case 'uh.js'/*tpa=http://deskwww.s3.amazonaws.com/new/javascripts/uh.js*/:
    (function() {
...
if(ga_linker) jQuery(function($){
  ...
  function linker_update(url){
    ...
    if(document.location.toString().indexOf('http://deskwww.s3.amazonaws.com/new/javascripts/get.desk.com') > 0) {
...
if(document.domain.toString() == 'http://deskwww.s3.amazonaws.com/new/javascripts/reg.desk.com') {
  document.getElementById('user_site_attributes_site_source_attributes_source_1').value = 'http://deskwww.s3.amazonaws.com/new/javascripts/reg.desk.com';
}
...
(function() {
  ...
  if (document.domain === "http://deskwww.s3.amazonaws.com/new/javascripts/desk.com" || document.domain === "http://deskwww.s3.amazonaws.com/new/javascripts/www.desk.com") {
    // Google Tag Manager Magic
    (function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
    new Date().getTime(),event:'gtm.js'/*tpa=http://deskwww.s3.amazonaws.com/new/javascripts/gtm.js*/});var f=d.getElementsByTagName(s)[0],
